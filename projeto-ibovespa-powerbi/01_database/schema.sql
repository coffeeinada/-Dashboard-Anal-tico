...
CREATE TABLE FatoProvento (
    ProventoID SERIAL PRIMARY KEY,
    EmpresaID INT REFERENCES DimEmpresa(EmpresaID),
    DataPagamento DATE REFERENCES DimData(Data),
    TipoProvento VARCHAR(20) NOT NULL, 
    ValorPorAcao NUMERIC(10,4) NOT NULL
);
